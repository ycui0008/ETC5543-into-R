...
Enable user to enter code is one advantage of using shiny-prerendered Rmd file. Different coding style and space between variables and arguments can make the comparison difficult.
